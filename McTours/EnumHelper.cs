...
namespace McTours
{
    public static class EnumHelper
    {
        ...
        public static readonly Dictionary<Gender, string> GenderName = new Dictionary<Gender, string>()
        {
        ...
        public static IEnumerable<ValueNameObject> GenderGetAll()
        {
            var all = new List<ValueNameObject>();
            foreach (var item in GenderName)
            {
                all.Add(new ValueNameObject()
                {
                    Value = (int)item.Key,
        ...
        {
            return GenderName.ContainsKey(gender)
                ? GenderName[gender]
                : string.Empty;
        }
